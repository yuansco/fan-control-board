...
void ssd1306_TestFonts() {
    ...
    ssd1306_WriteString("Font 16x26", Font_data, White);
    y += 26;
    #endif

    #ifdef SSD1306_INCLUDE_FONT_11x18
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("Font 11x18", Font_data, White);
    y += 18;
    #endif

    #ifdef SSD1306_INCLUDE_FONT_7x10
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("Font 7x10", Font_data, White);
    y += 10;
    #endif

    #ifdef SSD1306_INCLUDE_FONT_6x8
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("Font 6x8", Font_data, White);
    #endif
...
void ssd1306_TestFPS() {
    ...
    ssd1306_WriteString("Testing...", Font_data, Black);
    ssd1306_SetCursor(2, 18*2);
    ssd1306_WriteString("0123456789A", Font_data, Black);
   
    do {
        ssd1306_SetCursor(2, 18);
        ssd1306_WriteString(message, Font_data, Black);
        ssd1306_UpdateScreen();
    ...
    ssd1306_WriteString(buff, Font_data, Black);
    ssd1306_UpdateScreen();
}
