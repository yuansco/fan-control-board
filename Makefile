##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Sun Dec 15 17:11:22 CST 2024] 
##########################################################################################################################
...
# Frame path
FRAME_DIR:=$(wildcard Core/Frame)
# Board path
BOARD_DIR:=$(wildcard Core/Board/$(BOARD))
...
C_SOURCES += $(wildcard $(FRAME_DIR)/*.c)
C_SOURCES += $(wildcard $(BOARD_DIR)/*.c)
...
# compile gcc flags
ASFLAGS = $(MCU) $(AS_DEFS) $(AS_INCLUDES) $(OPT) $(WER) -Wall -fdata-sections -ffunction-sections

CFLAGS += $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) $(WER) -Wall -fdata-sections -ffunction-sections
